...
import com.vectras.as3.view.ZoomableTextView;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private final String obbName = "main." + obbVersion + ".com.vectras.as3.obb";
    ...
    private boolean checkDataFiles() {
        ...
        File homeDir = new File(getFilesDir(), "fex-rootfs");
    ...
    private void showAlphaStageDialog() {
        ...
        String githubIssuesLink = "https://github.com/xoureldeen-dev/AndStation3-App/issues";
    ...
    private void showInvalidObbFileDialog() {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View widget) {
                ...
                Uri uri = Uri.parse("https://andstation3.vercel.app");
        ...
        message.setSpan(clickableSpan, message.toString().indexOf("andstation3.vercel.app"), message.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
