...
import com.vectras.as3.x11.utils.SamsungDexUtils;
...
public class LoriePreferences extends AppCompatActivity {
    static final String ACTION_PREFERENCES_CHANGED = "com.vectras.as3.x11.ACTION_PREFERENCES_CHANGED";
    ...
    public static class LoriePreferenceFragment extends PreferenceFragmentCompat implements OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            intent.setPackage("com.vectras.as3");
            ...
            try {
                if (intent.getExtras() != null) {
                    ...
                    for (String key : intent.getExtras().keySet()) {
                        ...
                        intent0.setPackage("com.vectras.as3");
