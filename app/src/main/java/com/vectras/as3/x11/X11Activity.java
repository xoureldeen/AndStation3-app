...
import static com.vectras.as3.x11.CmdEntryPoint.ACTION_START;
import static com.vectras.as3.x11.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import com.vectras.as3.x11.input.InputEventSender;
import com.vectras.as3.x11.input.InputStub;
import com.vectras.as3.x11.input.TouchInputHandler.RenderStub;
import com.vectras.as3.x11.input.TouchInputHandler;
import com.vectras.as3.x11.utils.FullscreenWorkaround;
import com.vectras.as3.x11.utils.KeyInterceptor;
import com.vectras.as3.x11.utils.TermuxX11ExtraKeys;
import com.vectras.as3.x11.utils.X11ToolbarViewPager;
...
public class X11Activity extends AppCompatActivity implements View.OnApplyWindowInsetsListener {
    static final String ACTION_STOP = "com.vectras.as3.x11.ACTION_STOP";
    ...
    void onPreferencesChanged(String key) {
        ...
        if (p.getBoolean("enableAccessibilityServiceAutomatically", false)) {
            try {
                Settings.Secure.putString(getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES, "com.vectras.as3.x11/.utils.KeyInterceptor");
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Android requires WRITE_SECURE_SETTINGS permission to start accessibility service automatically.\n" +
                                ...
                                "adb shell pm grant com.vectras.as3.x11 android.permission.WRITE_SECURE_SETTINGS")
