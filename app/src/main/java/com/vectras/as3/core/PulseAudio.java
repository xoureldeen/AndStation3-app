...
public class PulseAudio {
    ...
    public void start() {
        String logPath = "/sdcard/Andstation3/pulseaudio.log";
        ...
        Runnable processRunnable = () -> {
            try {
                ProcessBuilder processBuilder = new ProcessBuilder(
                    ...
                    "--exit-idle-time=-1 > " + logPath
                );

                VectrasStatus.logInfo("Saving pulseaudio logs to /sdcard/Andstation3/pulseaudio.log");
